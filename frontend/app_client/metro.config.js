...
config.resolver.sourceExts = ['js', 'jsx', 'json', 'ts', 'tsx', 'mjs', 'mts'];

// 4. Exclude test files from the main bundle to prevent require statement errors
...
// 5. Add resolver for .mts files to be processed as TypeScript
